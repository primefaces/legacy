...
public class MenubarRenderer extends CoreRenderer{
	...
	public void encodeEnd(FacesContext facesContext, UIComponent component) throws IOException{
		...
		encodeMenuWidget(facesContext, menubar);
		encodeMenuMarkup(facesContext, menubar);
	}

	private void encodeMenuWidget(FacesContext facesContext, Menubar menubar) throws IOException{
		ResponseWriter writer = facesContext.getResponseWriter();
		String clientId = menubar.getClientId(facesContext);
		
		String menubarVar = getMenubarVar(menubar);
	...
	private String getMenubarVar(Menubar menubar) {
		if(menubar.getWidgetVar() != null)
			return menubar.getWidgetVar();
		else
			return "pf_menubar_" + menubar.getId();
	}
}