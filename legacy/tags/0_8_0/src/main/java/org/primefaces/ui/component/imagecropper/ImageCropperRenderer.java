...
public class ImageCropperRenderer extends CoreRenderer{
	...
	public void decode(FacesContext facesContext, UIComponent component) {
		...
		cropper.setSubmittedValue(submittedValue);
	}
	...
	public void encodeEnd(FacesContext facesContext, UIComponent component) throws IOException {
		...
		encodeImageCropperWidget(facesContext, cropper);
	}

	private void encodeImageCropperWidget(FacesContext facesContext, ImageCropper cropper) throws IOException{
		ResponseWriter writer = facesContext.getResponseWriter();
		String cropperVar = getImageCropperVar(cropper);
	...
	private String getImageCropperVar(ImageCropper imageCropper) {
		if(imageCropper.getWidgetVar() != null)
			return imageCropper.getWidgetVar();
		else
			return "pf_imageCropper_" + imageCropper.getId();
	}
