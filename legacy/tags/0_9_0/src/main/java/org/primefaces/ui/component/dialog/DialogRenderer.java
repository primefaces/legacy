...
public class DialogRenderer extends CoreRenderer{
	...
	private void encodeDialogScript(FacesContext facesContext, Dialog dialog) throws IOException{
		...
		writer.write(dialogVar + " = new YAHOO.widget.Panel('" + clientId + "',");
		writeCFGVariable(facesContext, dialog);
		writer.write(");\n");
	...
	private void writeCFGVariable(FacesContext facesContext, Dialog dialog) throws IOException {
		ResponseWriter writer = facesContext.getResponseWriter();
