...
public class EffectBuilderTest {
	...
	public void buildHighlightEffectWithNoOptions() {
		...
		assertEquals("jQuery(PrimeFaces.core.Utils.escapeClientId('id')).effect('highlight',{},1000);", effect);
	}
	...
	public void buildHighlightEffectWithAnOption() {
		...
		assertEquals("jQuery(PrimeFaces.core.Utils.escapeClientId('id')).effect('highlight',{startcolor:'#FFFFFF'},5000);", effect);
	}
	...
	public void buildHighlightEffectWitManyOptions() {
		...
		assertEquals("jQuery(PrimeFaces.core.Utils.escapeClientId('id')).effect('highlight',{startcolor:'#FFFFFF',endcolor:'#CCCCCC',restorecolor:'#000000'},1000);", effect);
	}	
}