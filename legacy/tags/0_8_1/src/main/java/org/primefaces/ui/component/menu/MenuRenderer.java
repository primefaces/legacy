...
public class MenuRenderer extends CoreRenderer{
	...
	public void encodeEnd(FacesContext facesContext, UIComponent component) throws IOException {
		...
		encodeMenuWidget(facesContext, menu);
		encodeMenuMarkup(facesContext, menu);
	}

	private void encodeMenuWidget(FacesContext facesContext, Menu menu) throws IOException{
		ResponseWriter writer = facesContext.getResponseWriter();
		String clientId = menu.getClientId(facesContext);
		
		String menuVar = getMenuVar(menu);
	...
	private String getMenuVar(Menu menu) {
		if(menu.getWidgetVar() != null)
			return menu.getWidgetVar();
		else
			return "pf_menu_" + menu.getId();
	}
}
