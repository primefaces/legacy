...
public class StackedColumnChartRenderer extends BaseChartRenderer {
	...
	private void encodeChartWidget(FacesContext facesContext, UIChart chart, String clientId, String xfieldName) throws IOException {
		...
		writer.write(getChartVar(chart) + " = new YAHOO.widget.StackedColumnChart(\"" + clientId + "\"," + getDataSourceVar(chart) + ",{");
