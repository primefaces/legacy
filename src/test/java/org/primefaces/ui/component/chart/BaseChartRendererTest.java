...
import org.primefaces.ui.component.chart.line.LineChart;
import org.primefaces.ui.component.chart.pie.PieChart;
...
public class BaseChartRendererTest {
	...
	@Test
	public void chartJSVarIsWidgetVarIfWidgetVarIsDefined() {
		PieChart chart = new PieChart();
		chart.setWidgetVar("pie");
		
		assertEquals("pie", renderer.getChartVar(chart));
	}
	
	@Test
	public void chartJSVarIsGeneratedIfWidgetVarIsNotDefined() {
		PieChart chart = new PieChart();
		chart.setId("id");
		
		assertEquals("pf_chart_id", renderer.getChartVar(chart));
	}
