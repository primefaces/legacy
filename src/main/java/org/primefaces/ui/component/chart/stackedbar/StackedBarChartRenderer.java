...
public class StackedBarChartRenderer extends BaseChartRenderer {
	...
	private void encodeChartWidget(FacesContext facesContext, UIChart chart, String clientId, String yfieldName) throws IOException {
		...
		writer.write(getChartVar(chart) + " = new YAHOO.widget.StackedBarChart(\"" + clientId + "\"," + getDataSourceVar(chart) + ",{");
