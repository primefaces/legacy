 ...
 */
package org.primefaces.ui.component.chart.bar;
...
public class BarChartRenderer extends CoreRenderer{
	...
	private void encodeChartWidget(FacesContext facesContext, BarChart chart) throws IOException{
		...
		writer.write(chartVariable + " = new YAHOO.widget.BarChart(\"" + chart.getClientId(facesContext) + "\"," + chartVariable + "_dataSource,{");
	...
	protected List<ChartSeries> getSeries(BarChart chart) {
	...
	protected void encodeChartMarkup(FacesContext facesContext, BarChart chart) throws IOException{
		ResponseWriter writer = facesContext.getResponseWriter();
	...
	protected String getChartVar(BarChart chart) {
