 ...
 */
package org.primefaces.ui.component.chart.column;
...
public class ColumnChartRenderer extends CoreRenderer{
	...
	private void encodeChartWidget(FacesContext facesContext, ColumnChart chart) throws IOException{
		...
		writer.write(chartVariable + " = new YAHOO.widget.ColumnChart(\"" + chart.getClientId(facesContext) + "\"," + chartVariable + "_dataSource,{");
	...
	protected List<ChartSeries> getSeries(ColumnChart chart) {
	...
	protected void encodeChartMarkup(FacesContext facesContext, ColumnChart chart) throws IOException{
		ResponseWriter writer = facesContext.getResponseWriter();
	...
	protected String getChartVar(ColumnChart chart) {
