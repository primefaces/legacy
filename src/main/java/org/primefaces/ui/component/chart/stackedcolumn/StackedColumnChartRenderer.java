 ...
 */
package org.primefaces.ui.component.chart.stackedcolumn;
...
public class StackedColumnChartRenderer extends CoreRenderer{
	...
	private void encodeChartWidget(FacesContext facesContext, StackedColumnChart chart) throws IOException{
		...
		writer.write(chartVariable + " = new YAHOO.widget.StackedColumnChart(\"" + chart.getClientId(facesContext) + "\"," + chartVariable + "_dataSource,{");
	...
	protected List<ChartSeries> getSeries(StackedColumnChart chart) {
	...
	protected void encodeChartMarkup(FacesContext facesContext, StackedColumnChart chart) throws IOException{
		ResponseWriter writer = facesContext.getResponseWriter();
	...
	protected String getChartVar(StackedColumnChart chart) {
