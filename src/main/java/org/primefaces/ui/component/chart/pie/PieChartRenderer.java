...
public class PieChartRenderer extends BaseChartRenderer implements PartialRenderer {
	...
	private void encodeChartWidget(FacesContext facesContext, UIChart chart, String clientId, String categoryFieldName, String dataFieldName) throws IOException {
		ResponseWriter writer = facesContext.getResponseWriter();
