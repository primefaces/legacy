...
public class DialogRenderer extends CoreRenderer{
	...
	public void encodeEnd(FacesContext facesContext, UIComponent component) throws IOException {
		...
		encodeOverlayPanelWidget(facesContext, dialog);
		encodeOverlayPanelMarkup(facesContext, dialog);
	}
	...
	private void encodeOverlayPanelWidget(FacesContext facesContext, Dialog dialog) throws IOException{
		ResponseWriter writer = facesContext.getResponseWriter();
		String clientId = dialog.getClientId(facesContext);
		
		String dialogVar = getDialogVar(dialog);
	...
	private void encodeOverlayPanelMarkup(FacesContext facesContext, Dialog dialog) throws IOException{
		ResponseWriter writer = facesContext.getResponseWriter();
		String clientId = dialog.getClientId(facesContext);
	...
	private String getDialogVar(Dialog dialog) {
		if(dialog.getWidgetVar() != null)
			return dialog.getWidgetVar();
		else
			return "pf_dialog_" + dialog.getId();
	}
}