...
public class DataExporter implements ActionListener, StateHolder {
	...
	public DataExporter(ValueExpression target, ValueExpression type, ValueExpression fileName, ValueExpression exludeColumns) {
		this.target = target;
		this.type = type;
	...
	public void processAction(ActionEvent event){
		...
		try {
			...
			exporter.export(facesContext, table, outputFileName, excludedColumnIndexes);
