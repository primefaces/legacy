...
public class AutoCompleteRenderer extends CoreRenderer implements PartialRenderer {
	...
	private final static Logger logger = LoggerFactory.getLogger(AutoCompleteRenderer.class);
	...
	public Object getConvertedValue(FacesContext facesContext, UIComponent component, Object submittedValue) throws ConverterException {
		...
		//Try to guess
			...
			Class<?> valueType = autoComplete.getValueExpression("value").getType(facesContext.getELContext());
		...
		logger.debug("No converter found for autoComplete:'{}'", autoComplete.getClientId(facesContext));
