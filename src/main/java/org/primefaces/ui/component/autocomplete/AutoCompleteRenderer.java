...
public class AutoCompleteRenderer extends CoreRenderer implements PartialRenderer{
	...
	public void encodeEnd(FacesContext facesContext, UIComponent component) throws IOException {
		...
		encodeAutoCompleteWidget(facesContext, autoComplete);
	...
	protected void encodeAutoCompleteWidget(FacesContext facesContext, AutoComplete autoComplete) throws IOException {
		ResponseWriter writer = facesContext.getResponseWriter();
		String clientId = autoComplete.getClientId(facesContext);
		String autoCompleteVar = getAutoCompleteVar(autoComplete);
	...
	protected String getAutoCompleteVar(AutoComplete autoComplete){
		if(autoComplete.getWidgetVar() != null)
			return autoComplete.getWidgetVar();
		else
			return "pf_autoComplete_" + autoComplete.getId();
	}
}