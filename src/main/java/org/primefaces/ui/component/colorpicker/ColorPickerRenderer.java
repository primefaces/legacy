...
public class ColorPickerRenderer extends CoreRenderer {
	...
	protected void encodeColorPickerScript(FacesContext facesContext, ColorPicker colorPicker) throws IOException {
		...
		String pickerVar = getPickerVar(colorPicker);
	...
	protected String getPickerVar(ColorPicker picker) {
		if(picker.getWidgetVar() != null)
			return picker.getWidgetVar();
		else
			return "pf_colorPicker_" + picker.getId();
	}
}